...
"""Auto-generated BioModule wrapper for Single cell model with variable ion concentrations and Na+/K+ ATPase (Krishnan et al. 2015).

Source: modeldb:169023
Original: https://modeldb.science/169023
Standard: other
...
class OtherSingleCellModelWithVariableIonConcentrationsAndNaK(bsim.BioModule):
    """Placeholder BioModule wrapper for: Single cell model with variable ion concentrations and Na+/K+ ATPase (Krishnan et al. 2015).
...
SingleCellModelWithVariableIonConcentratio169023Model = OtherSingleCellModelWithVariableIonConcentrationsAndNaK
