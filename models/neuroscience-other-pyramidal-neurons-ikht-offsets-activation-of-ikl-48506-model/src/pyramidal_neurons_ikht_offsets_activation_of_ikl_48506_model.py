...
"""Auto-generated BioModule wrapper for Pyramidal neurons: IKHT offsets activation of IKLT to increase gain (Fernandez et al 2005).

Source: modeldb:48506
Original: https://modeldb.science/48506
Standard: other
...
class OtherPyramidalNeuronsIkhtOffsetsActivationOfIkltTo(bsim.BioModule):
    """Placeholder BioModule wrapper for: Pyramidal neurons: IKHT offsets activation of IKLT to increase gain (Fernandez et al 2005).
...
PyramidalNeuronsIkhtOffsetsActivationOfIkl48506Model = OtherPyramidalNeuronsIkhtOffsetsActivationOfIkltTo
