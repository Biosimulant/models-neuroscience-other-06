...
"""Auto-generated BioModule wrapper for STDP and NMDAR Subunits (Gerkin et al. 2007).

Source: modeldb:87216
Original: https://modeldb.science/87216
Standard: other
...
class OtherStdpAndNmdarSubunitsGerkinEtAl2007(biosim.BioModule):
    """Placeholder BioModule wrapper for: STDP and NMDAR Subunits (Gerkin et al. 2007).
    ...
    def __init__(self, model_path: str = "data/87216.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
StdpAndNmdarSubunitsGerkinEtAl200787216Model = OtherStdpAndNmdarSubunitsGerkinEtAl2007
