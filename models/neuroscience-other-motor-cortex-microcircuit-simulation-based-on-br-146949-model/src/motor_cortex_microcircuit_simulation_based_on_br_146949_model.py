...
"""Auto-generated BioModule wrapper for Motor cortex microcircuit simulation based on brain activity mapping (Chadderdon et al. 2014).

Source: modeldb:146949
Original: https://modeldb.science/146949
Standard: other
...
class OtherMotorCortexMicrocircuitSimulationBasedOnBrain(biosim.BioModule):
    """BioModule wrapper for: Motor cortex microcircuit simulation based on brain activity mapping (Chadderdon et al. 2014)."""

    def __init__(self, model_path: str = "data/146949.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
MotorCortexMicrocircuitSimulationBasedOnBr146949Model = OtherMotorCortexMicrocircuitSimulationBasedOnBrain
