...
"""Auto-generated BioModule wrapper for Squid axon (Hodgkin, Huxley 1952) (LabAXON).

Source: modeldb:84649
Original: https://modeldb.science/84649
Standard: other
...
class OtherSquidAxonHodgkinHuxley1952Labaxon(biosim.BioModule):
    """Placeholder BioModule wrapper for: Squid axon (Hodgkin, Huxley 1952) (LabAXON).
    ...
    def __init__(self, model_path: str = "data/84649.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
SquidAxonHodgkinHuxley1952Labaxon84649Model = OtherSquidAxonHodgkinHuxley1952Labaxon
