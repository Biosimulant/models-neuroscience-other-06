...
"""Auto-generated BioModule wrapper for The subcellular distribution of T-type Ca2+ channels in LGN interneurons (Allken et al. 2014).

Source: modeldb:156039
Original: https://modeldb.science/156039
Standard: other
...
class OtherTheSubcellularDistributionOfTTypeCa2ChannelsInLgn(biosim.BioModule):
    """BioModule wrapper for: The subcellular distribution of T-type Ca2+ channels in LGN interneurons (Allken et al. 2014).""""""

    def __init__(self, model_path: str = "data/156039.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
TheSubcellularDistributionOfTTypeCa2Chann156039Model = OtherTheSubcellularDistributionOfTTypeCa2ChannelsInLgn
