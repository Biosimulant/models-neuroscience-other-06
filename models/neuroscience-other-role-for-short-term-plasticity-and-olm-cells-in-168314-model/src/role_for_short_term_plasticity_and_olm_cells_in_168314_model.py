...
"""Auto-generated BioModule wrapper for Role for short term plasticity and OLM cells in containing spread of excitation (Hummos et al 2014).

Source: modeldb:168314
Original: https://modeldb.science/168314
Standard: other
...
class OtherRoleForShortTermPlasticityAndOlmCellsInContaining(bsim.BioModule):
    """Placeholder BioModule wrapper for: Role for short term plasticity and OLM cells in containing spread of excitation (Hummos et al 2014).
...
RoleForShortTermPlasticityAndOlmCellsIn168314Model = OtherRoleForShortTermPlasticityAndOlmCellsInContaining
