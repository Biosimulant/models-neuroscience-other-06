...
"""Auto-generated BioModule wrapper for Ribbon Synapse (Sikora et al 2005).

Source: modeldb:50997
Original: https://modeldb.science/50997
Standard: other
...
class OtherRibbonSynapseSikoraEtAl2005(biosim.BioModule):
    """Placeholder BioModule wrapper for: Ribbon Synapse (Sikora et al 2005).
    ...
    def __init__(self, model_path: str = "data/50997.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
RibbonSynapseSikoraEtAl200550997Model = OtherRibbonSynapseSikoraEtAl2005
