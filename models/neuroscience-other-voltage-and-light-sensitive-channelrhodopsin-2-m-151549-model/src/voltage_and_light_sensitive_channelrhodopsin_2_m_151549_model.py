...
"""Auto-generated BioModule wrapper for Voltage and light-sensitive Channelrhodopsin-2 model (ChR2) (Williams et al. 2013).

Source: modeldb:151549
Original: https://modeldb.science/151549
Standard: other
...
class OtherVoltageAndLightSensitiveChannelrhodopsin2ModelChr2(biosim.BioModule):
    """BioModule wrapper for: Voltage and light-sensitive Channelrhodopsin-2 model (ChR2) (Williams et al. 2013).""""""

    def __init__(self, model_path: str = "data/151549.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
VoltageAndLightSensitiveChannelrhodopsin2M151549Model = OtherVoltageAndLightSensitiveChannelrhodopsin2ModelChr2
