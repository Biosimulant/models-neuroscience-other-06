...
"""Auto-generated BioModule wrapper for The virtual slice setup (Lytton et al. 2008).

Source: modeldb:116838
Original: https://modeldb.science/116838
Standard: other
...
class OtherTheVirtualSliceSetupLyttonEtAl2008(biosim.BioModule):
    """Placeholder BioModule wrapper for: The virtual slice setup (Lytton et al. 2008).
    ...
    def __init__(self, model_path: str = "data/116838.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
TheVirtualSliceSetupLyttonEtAl2008116838Model = OtherTheVirtualSliceSetupLyttonEtAl2008
