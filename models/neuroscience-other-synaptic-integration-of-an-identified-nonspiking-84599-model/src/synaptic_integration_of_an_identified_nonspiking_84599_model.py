...
"""Auto-generated BioModule wrapper for Synaptic integration of an identified nonspiking interneuron in crayfish (Takashima et al 2006).

Source: modeldb:84599
Original: https://modeldb.science/84599
Standard: other
...
class OtherSynapticIntegrationOfAnIdentifiedNonspiking(biosim.BioModule):
    """BioModule wrapper for: Synaptic integration of an identified nonspiking interneuron in crayfish (Takashima et al 2006).""""""

    def __init__(self, model_path: str = "data/84599.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
SynapticIntegrationOfAnIdentifiedNonspiking84599Model = OtherSynapticIntegrationOfAnIdentifiedNonspiking
