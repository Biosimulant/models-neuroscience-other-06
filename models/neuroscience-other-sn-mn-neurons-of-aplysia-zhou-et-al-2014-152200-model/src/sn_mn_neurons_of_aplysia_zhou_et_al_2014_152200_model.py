...
"""Auto-generated BioModule wrapper for SN-MN neurons of Aplysia (Zhou et al. 2014).

Source: modeldb:152200
Original: https://modeldb.science/152200
Standard: other
...
class OtherSnMnNeuronsOfAplysiaZhouEtAl2014(biosim.BioModule):
    """Placeholder BioModule wrapper for: SN-MN neurons of Aplysia (Zhou et al. 2014).
    ...
    def __init__(self, model_path: str = "data/152200.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
SnMnNeuronsOfAplysiaZhouEtAl2014152200Model = OtherSnMnNeuronsOfAplysiaZhouEtAl2014
