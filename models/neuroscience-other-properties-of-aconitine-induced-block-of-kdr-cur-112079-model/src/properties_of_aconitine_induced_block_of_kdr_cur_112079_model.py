...
"""Auto-generated BioModule wrapper for Properties of aconitine-induced block of KDR current in NG108-15 neurons (Lin et al. 2008).

Source: modeldb:112079
Original: https://modeldb.science/112079
Standard: other
...
class OtherPropertiesOfAconitineInducedBlockOfKdrCurrentIn(bsim.BioModule):
    """Placeholder BioModule wrapper for: Properties of aconitine-induced block of KDR current in NG108-15 neurons (Lin et al. 2008).
...
PropertiesOfAconitineInducedBlockOfKdrCur112079Model = OtherPropertiesOfAconitineInducedBlockOfKdrCurrentIn
