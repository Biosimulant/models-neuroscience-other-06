...
"""Auto-generated BioModule wrapper for Perturbation sensitivity implies high noise and suggests rate coding in cortex (London et al. 2010).

Source: modeldb:144027
Original: https://modeldb.science/144027
Standard: other
...
class OtherPerturbationSensitivityImpliesHighNoiseAndSuggests(bsim.BioModule):
    """Placeholder BioModule wrapper for: Perturbation sensitivity implies high noise and suggests rate coding in cortex (London et al. 2010).
...
PerturbationSensitivityImpliesHighNoiseAnd144027Model = OtherPerturbationSensitivityImpliesHighNoiseAndSuggests
