...
"""Auto-generated BioModule wrapper for Olfactory bulb mitral cell gap junction NN model: burst firing and synchrony (O`Connor et al. 2012).

Source: modeldb:146030
Original: https://modeldb.science/146030
Standard: other
...
class OtherOlfactoryBulbMitralCellGapJunctionNnModelBurst(bsim.BioModule):
    """Placeholder BioModule wrapper for: Olfactory bulb mitral cell gap junction NN model: burst firing and synchrony (O`Connor et al. 2012).
...
OlfactoryBulbMitralCellGapJunctionNnModel146030Model = OtherOlfactoryBulbMitralCellGapJunctionNnModelBurst
