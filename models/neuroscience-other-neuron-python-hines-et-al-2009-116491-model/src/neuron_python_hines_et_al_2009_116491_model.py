...
"""Auto-generated BioModule wrapper for NEURON + Python (Hines et al. 2009).

Source: modeldb:116491
Original: https://modeldb.science/116491
Standard: other
...
class OtherNeuronPythonHinesEtAl2009(biosim.BioModule):
    """Placeholder BioModule wrapper for: NEURON + Python (Hines et al. 2009).
    ...
    def __init__(self, model_path: str = "data/116491.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
NeuronPythonHinesEtAl2009116491Model = OtherNeuronPythonHinesEtAl2009
