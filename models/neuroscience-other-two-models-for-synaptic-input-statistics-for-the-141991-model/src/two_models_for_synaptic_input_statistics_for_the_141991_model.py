...
"""Auto-generated BioModule wrapper for Two Models for synaptic input statistics for the MSO neuron model (Jercog et al. 2010).

Source: modeldb:141991
Original: https://modeldb.science/141991
Standard: other
...
class OtherTwoModelsForSynapticInputStatisticsForTheMsoNeuron(bsim.BioModule):
    """Placeholder BioModule wrapper for: Two Models for synaptic input statistics for the MSO neuron model (Jercog et al. 2010).
...
TwoModelsForSynapticInputStatisticsForThe141991Model = OtherTwoModelsForSynapticInputStatisticsForTheMsoNeuron
