...
"""Auto-generated BioModule wrapper for T channel currents (Vitko et al 2005).

Source: modeldb:53965
Original: https://modeldb.science/53965
Standard: other
...
class OtherTChannelCurrentsVitkoEtAl2005(biosim.BioModule):
    """Placeholder BioModule wrapper for: T channel currents (Vitko et al 2005).
    ...
    def __init__(self, model_path: str = "data/53965.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
TChannelCurrentsVitkoEtAl200553965Model = OtherTChannelCurrentsVitkoEtAl2005
