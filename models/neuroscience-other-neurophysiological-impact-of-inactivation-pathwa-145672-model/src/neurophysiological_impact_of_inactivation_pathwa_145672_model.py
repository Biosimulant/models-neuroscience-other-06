...
"""Auto-generated BioModule wrapper for Neurophysiological impact of inactivation pathways in A-type K+ channels (Fineberg et al 2012).

Source: modeldb:145672
Original: https://modeldb.science/145672
Standard: other
...
class OtherNeurophysiologicalImpactOfInactivationPathwaysInA(bsim.BioModule):
    """Placeholder BioModule wrapper for: Neurophysiological impact of inactivation pathways in A-type K+ channels (Fineberg et al 2012).
...
NeurophysiologicalImpactOfInactivationPathwa145672Model = OtherNeurophysiologicalImpactOfInactivationPathwaysInA
