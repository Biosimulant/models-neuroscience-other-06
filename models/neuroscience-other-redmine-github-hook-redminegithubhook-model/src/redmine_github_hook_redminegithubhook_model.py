...
"""Auto-generated BioModule wrapper for redmine_github_hook.

Source: opensourcebrain:redmine_github_hook
Original: https://github.com/OpenSourceBrain/redmine_github_hook
Standard: other
...
class OtherRedmineGithubHook(biosim.BioModule):
    """Placeholder BioModule wrapper for: redmine_github_hook.
...
RedmineGithubHookRedminegithubhookModel = OtherRedmineGithubHook
