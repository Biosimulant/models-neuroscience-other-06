...
"""Auto-generated tests for RedmineGithubHookRedminegithubhookModel.
...
from src.redmine_github_hook_redminegithubhook_model import RedmineGithubHookRedminegithubhookModel  # noqa: E402
from bsim.signals import BioSignal  # noqa: E402


def test_instantiation() -> None:
    module = RedmineGithubHookRedminegithubhookModel()
...
def test_advance_produces_outputs() -> None:
    module = RedmineGithubHookRedminegithubhookModel(min_dt=0.1)
