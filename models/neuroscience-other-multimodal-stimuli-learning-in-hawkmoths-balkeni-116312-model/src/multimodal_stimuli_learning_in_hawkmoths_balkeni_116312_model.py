...
class OtherMultimodalStimuliLearningInHawkmothsBalkeniusEtAl(biosim.BioModule):
    """BioModule wrapper for: Multimodal stimuli learning in hawkmoths (Balkenius et al. 2008).""""""
