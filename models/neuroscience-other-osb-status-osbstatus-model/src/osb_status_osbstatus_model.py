...
"""Auto-generated BioModule wrapper for OSB_Status.

Source: opensourcebrain:OSB_Status
Original: https://github.com/OpenSourceBrain/OSB_Status
Standard: other
...
class OtherOsbStatus(biosim.BioModule):
    """Placeholder BioModule wrapper for: OSB_Status.
...
OsbStatusOsbstatusModel = OtherOsbStatus
