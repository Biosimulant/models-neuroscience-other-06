...
"""Auto-generated BioModule wrapper for Study of augmented Rubin and Terman 2004 deep brain stim. model in Parkinsons (Pascual et al. 2006).

Source: modeldb:97850
Original: https://modeldb.science/97850
Standard: other
...
class OtherStudyOfAugmentedRubinAndTerman2004DeepBrainStim(biosim.BioModule):
    """BioModule wrapper for: Study of augmented Rubin and Terman 2004 deep brain stim. model in Parkinsons (Pascual et al. 2006).""""""

    def __init__(self, model_path: str = "data/97850.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
StudyOfAugmentedRubinAndTerman2004DeepBr97850Model = OtherStudyOfAugmentedRubinAndTerman2004DeepBrainStim
