...
"""Auto-generated BioModule wrapper for Pyramidal neuron coincidence detection tuned by dendritic branching pattern (Schaefer et al 2003).

Source: modeldb:83344
Original: https://modeldb.science/83344
Standard: other
...
class OtherPyramidalNeuronCoincidenceDetectionTunedByDendritic(biosim.BioModule):
    """BioModule wrapper for: Pyramidal neuron coincidence detection tuned by dendritic branching pattern (Schaefer et al 2003).""""""

    def __init__(self, model_path: str = "data/83344.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
PyramidalNeuronCoincidenceDetectionTunedBy83344Model = OtherPyramidalNeuronCoincidenceDetectionTunedByDendritic
