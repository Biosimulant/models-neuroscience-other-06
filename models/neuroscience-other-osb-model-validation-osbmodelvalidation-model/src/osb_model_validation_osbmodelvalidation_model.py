...
"""Auto-generated BioModule wrapper for osb-model-validation.

Source: opensourcebrain:osb-model-validation
Original: https://github.com/OpenSourceBrain/osb-model-validation
Standard: other
...
class OtherOsbModelValidation(biosim.BioModule):
    """Placeholder BioModule wrapper for: osb-model-validation.
...
OsbModelValidationOsbmodelvalidationModel = OtherOsbModelValidation
