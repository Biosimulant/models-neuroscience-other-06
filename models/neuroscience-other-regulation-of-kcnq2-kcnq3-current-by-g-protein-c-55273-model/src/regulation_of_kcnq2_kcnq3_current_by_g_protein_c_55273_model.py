...
"""Auto-generated BioModule wrapper for Regulation of KCNQ2/KCNQ3 current by G protein cycling (Suh et al 2004).

Source: modeldb:55273
Original: https://modeldb.science/55273
Standard: other
...
class OtherRegulationOfKcnq2Kcnq3CurrentByGProteinCyclingSuh(biosim.BioModule):
    """BioModule wrapper for: Regulation of KCNQ2/KCNQ3 current by G protein cycling (Suh et al 2004).""""""

    def __init__(self, model_path: str = "data/55273.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
RegulationOfKcnq2Kcnq3CurrentByGProteinC55273Model = OtherRegulationOfKcnq2Kcnq3CurrentByGProteinCyclingSuh
