...
"""Auto-generated BioModule wrapper for Reliability of spike timing is a general property of spiking model neurons (Brette & Guigon 2003).

Source: modeldb:154293
Original: https://modeldb.science/154293
Standard: other
...
class OtherReliabilityOfSpikeTimingIsAGeneralPropertyOf(biosim.BioModule):
    """BioModule wrapper for: Reliability of spike timing is a general property of spiking model neurons (Brette & Guigon 2003).""""""

    def __init__(self, model_path: str = "data/154293.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ReliabilityOfSpikeTimingIsAGeneralPropert154293Model = OtherReliabilityOfSpikeTimingIsAGeneralPropertyOf
