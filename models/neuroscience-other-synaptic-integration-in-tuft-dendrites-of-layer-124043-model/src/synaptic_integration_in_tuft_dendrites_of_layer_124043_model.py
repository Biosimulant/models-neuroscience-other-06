...
"""Auto-generated BioModule wrapper for Synaptic integration in tuft dendrites of layer 5 pyramidal neurons (Larkum et al. 2009).

Source: modeldb:124043
Original: https://modeldb.science/124043
Standard: other
...
class OtherSynapticIntegrationInTuftDendritesOfLayer5Pyramidal(bsim.BioModule):
    """Placeholder BioModule wrapper for: Synaptic integration in tuft dendrites of layer 5 pyramidal neurons (Larkum et al. 2009).
...
SynapticIntegrationInTuftDendritesOfLayer124043Model = OtherSynapticIntegrationInTuftDendritesOfLayer5Pyramidal
