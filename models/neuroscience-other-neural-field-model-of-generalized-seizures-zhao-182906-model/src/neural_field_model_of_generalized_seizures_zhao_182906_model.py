...
class OtherNeuralFieldModelOfGeneralizedSeizuresZhaoEtAl2015(biosim.BioModule):
    """BioModule wrapper for: Neural-field model of generalized seizures (Zhao et al., 2015).""""""
