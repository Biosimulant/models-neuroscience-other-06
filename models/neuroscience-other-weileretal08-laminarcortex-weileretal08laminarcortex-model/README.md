# WeilerEtAl08-LaminarCortex

**Source**: [opensourcebrain](https://github.com/OpenSourceBrain/WeilerEtAl08-LaminarCortex)
**Standard**: other
...
models:
  - path: ../../models/neuroscience-other-weileretal08-laminarcortex-weileretal08laminarcortex-model
    alias: model
```
