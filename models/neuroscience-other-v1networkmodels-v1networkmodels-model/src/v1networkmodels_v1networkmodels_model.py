...
"""Auto-generated BioModule wrapper for V1NetworkModels.

Source: opensourcebrain:V1NetworkModels
Original: https://github.com/OpenSourceBrain/V1NetworkModels
Standard: other
...
class OtherV1networkmodels(biosim.BioModule):
    """Placeholder BioModule wrapper for: V1NetworkModels.
...
V1networkmodelsV1networkmodelsModel = OtherV1networkmodels
