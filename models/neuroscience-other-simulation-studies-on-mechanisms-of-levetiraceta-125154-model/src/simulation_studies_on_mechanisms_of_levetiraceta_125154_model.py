...
"""Auto-generated BioModule wrapper for Simulation studies on mechanisms of levetiracetam-mediated inhibition of IK(DR) (Huang et al. 2009).

Source: modeldb:125154
Original: https://modeldb.science/125154
Standard: other
...
class OtherSimulationStudiesOnMechanismsOfLevetiracetamMediated(biosim.BioModule):
    """BioModule wrapper for: Simulation studies on mechanisms of levetiracetam-mediated inhibition of IK(DR) (Huang et al. 2009).""""""

    def __init__(self, model_path: str = "data/125154.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
SimulationStudiesOnMechanismsOfLevetiraceta125154Model = OtherSimulationStudiesOnMechanismsOfLevetiracetamMediated
