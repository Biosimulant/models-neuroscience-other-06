...
"""Auto-generated BioModule wrapper for Reichardt Model for Motion Detection in the Fly Visual System  (Tuthill et al, 2011).

Source: modeldb:168957
Original: https://modeldb.science/168957
Standard: other
...
class OtherReichardtModelForMotionDetectionInTheFlyVisual(bsim.BioModule):
    """Placeholder BioModule wrapper for: Reichardt Model for Motion Detection in the Fly Visual System  (Tuthill et al, 2011).
...
ReichardtModelForMotionDetectionInTheFly168957Model = OtherReichardtModelForMotionDetectionInTheFlyVisual
