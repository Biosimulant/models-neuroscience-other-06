...
"""Auto-generated BioModule wrapper for Response properties of neocort. neurons to temporally modulated noisy inputs (Koendgen et al. 2008).

Source: modeldb:118631
Original: https://modeldb.science/118631
Standard: other
...
class OtherResponsePropertiesOfNeocortNeuronsToTemporally(bsim.BioModule):
    """Placeholder BioModule wrapper for: Response properties of neocort. neurons to temporally modulated noisy inputs (Koendgen et al. 2008).
...
ResponsePropertiesOfNeocortNeuronsToTempor118631Model = OtherResponsePropertiesOfNeocortNeuronsToTemporally
