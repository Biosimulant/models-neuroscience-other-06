...
"""Auto-generated BioModule wrapper for Rat phrenic motor neuron (Amini et al 2004).

Source: modeldb:53572
Original: https://modeldb.science/53572
Standard: other
...
class OtherRatPhrenicMotorNeuronAminiEtAl2004(biosim.BioModule):
    """Placeholder BioModule wrapper for: Rat phrenic motor neuron (Amini et al 2004).
    ...
    def __init__(self, model_path: str = "data/53572.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
RatPhrenicMotorNeuronAminiEtAl200453572Model = OtherRatPhrenicMotorNeuronAminiEtAl2004
