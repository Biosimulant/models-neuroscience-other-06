...
"""Auto-generated BioModule wrapper for Sensory feedback in an oscillatory interference model of place cell activity (Monaco et al.  2011).

Source: modeldb:137676
Original: https://modeldb.science/137676
Standard: other
...
class OtherSensoryFeedbackInAnOscillatoryInterferenceModelOf(bsim.BioModule):
    """Placeholder BioModule wrapper for: Sensory feedback in an oscillatory interference model of place cell activity (Monaco et al.  2011).
...
SensoryFeedbackInAnOscillatoryInterference137676Model = OtherSensoryFeedbackInAnOscillatoryInterferenceModelOf
