...
"""Auto-generated BioModule wrapper for O-LM interneuron model (Lawrence et al. 2006).

Source: modeldb:102288
Original: https://modeldb.science/102288
Standard: other
...
class OtherOLmInterneuronModelLawrenceEtAl2006(biosim.BioModule):
    """Placeholder BioModule wrapper for: O-LM interneuron model (Lawrence et al. 2006).
    ...
    def __init__(self, model_path: str = "data/102288.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
OLmInterneuronModelLawrenceEtAl2006102288Model = OtherOLmInterneuronModelLawrenceEtAl2006
