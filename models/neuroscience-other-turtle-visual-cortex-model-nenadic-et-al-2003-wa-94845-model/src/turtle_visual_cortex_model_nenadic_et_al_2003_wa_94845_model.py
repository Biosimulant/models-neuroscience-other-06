...
class OtherTurtleVisualCortexModelNenadicEtAl2003WangEtAl(biosim.BioModule):
    """BioModule wrapper for: Turtle visual cortex model (Nenadic et al. 2003, Wang et al. 2005, Wang et al. 2006).""""""
