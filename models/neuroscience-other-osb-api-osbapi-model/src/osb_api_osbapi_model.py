...
"""Auto-generated BioModule wrapper for OSB_API.

Source: opensourcebrain:OSB_API
Original: https://github.com/OpenSourceBrain/OSB_API
Standard: other
...
class OtherOsbApi(biosim.BioModule):
    """Placeholder BioModule wrapper for: OSB_API.
