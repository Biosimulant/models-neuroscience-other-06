...
"""Auto-generated BioModule wrapper for Theta phase precession in a model CA3 place cell (Baker and Olds 2007).

Source: modeldb:98003
Original: https://modeldb.science/98003
Standard: other
...
class OtherThetaPhasePrecessionInAModelCa3PlaceCellBakerAnd(biosim.BioModule):
    """BioModule wrapper for: Theta phase precession in a model CA3 place cell (Baker and Olds 2007).""""""

    def __init__(self, model_path: str = "data/98003.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
ThetaPhasePrecessionInAModelCa3PlaceCell98003Model = OtherThetaPhasePrecessionInAModelCa3PlaceCellBakerAnd
