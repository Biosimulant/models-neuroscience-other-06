...
"""Auto-generated BioModule wrapper for Olfactory bulb mitral and granule cell column formation (Migliore et al. 2007).

Source: modeldb:114665
Original: https://modeldb.science/114665
Standard: other
...
class OtherOlfactoryBulbMitralAndGranuleCellColumnFormation(bsim.BioModule):
    """Placeholder BioModule wrapper for: Olfactory bulb mitral and granule cell column formation (Migliore et al. 2007).
...
OlfactoryBulbMitralAndGranuleCellColumnFo114665Model = OtherOlfactoryBulbMitralAndGranuleCellColumnFormation
