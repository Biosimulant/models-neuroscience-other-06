...
"""Auto-generated BioModule wrapper for pynsgr.

Source: opensourcebrain:pynsgr
Original: https://github.com/OpenSourceBrain/pynsgr
Standard: other
...
class OtherPynsgr(biosim.BioModule):
    """Placeholder BioModule wrapper for: pynsgr.
