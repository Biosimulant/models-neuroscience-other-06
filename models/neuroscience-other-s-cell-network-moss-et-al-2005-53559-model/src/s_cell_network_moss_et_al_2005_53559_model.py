...
"""Auto-generated BioModule wrapper for S cell network (Moss et al 2005).

Source: modeldb:53559
Original: https://modeldb.science/53559
Standard: other
...
class OtherSCellNetworkMossEtAl2005(biosim.BioModule):
    """Placeholder BioModule wrapper for: S cell network (Moss et al 2005).
    ...
    def __init__(self, model_path: str = "data/53559.zip", min_dt: float = 0.01) -> None:
        self.min_dt = min_dt
...
SCellNetworkMossEtAl200553559Model = OtherSCellNetworkMossEtAl2005
