...
"""Auto-generated BioModule wrapper for Ventricular cell model (Guinea-pig-type) (Luo, Rudy 1991, +11 other papers!) (C++).

Source: modeldb:55859
Original: https://modeldb.science/55859
Standard: other
...
class OtherVentricularCellModelGuineaPigTypeLuoRudy199111(bsim.BioModule):
    """Placeholder BioModule wrapper for: Ventricular cell model (Guinea-pig-type) (Luo, Rudy 1991, +11 other papers!) (C++).
...
VentricularCellModelGuineaPigTypeLuoRudy55859Model = OtherVentricularCellModelGuineaPigTypeLuoRudy199111
