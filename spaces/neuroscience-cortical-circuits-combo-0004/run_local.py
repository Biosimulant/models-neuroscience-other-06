#!/usr/bin/env python3
"""Run generated space: neuroscience-cortical-circuits-combo-0004."""
...
def main() -> None:
    ...
    print(f"Completed {space.get('title', 'neuroscience-cortical-circuits-combo-0004')} duration={duration} tick_dt={tick_dt}")
