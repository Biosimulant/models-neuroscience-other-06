#!/usr/bin/env python3
"""Run generated space: neuroscience-hippocampal-circuits-combo-0067."""
...
def _repo_root_map(current_repo_root: Path) -> dict[str, Path]:
    ...
    return {
        "Biosimulant/models-neuroscience-other-06": current_repo_root.resolve(),
...
def main() -> None:
    ...
    print(f"Completed {space.get('title', 'neuroscience-hippocampal-circuits-combo-0067')} duration={duration} tick_dt={tick_dt}")
